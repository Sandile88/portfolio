...
const Hero = () => {
  ...
  const profileImageUrl = "https://res.cloudinary.com/dyfc8prpv/image/upload/v1732467342/IMG_2782_1_eknrwx.jpg";
    ...
    return (
      <section id="about" className="min-h-screen pt-20 pb-12 bg-amber-50 sm:pt-24 lg:pt-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            <p className="text-xl lg:text-2xl text-neutral-700 mb-6">
            ...
            <div className="flex gap-6 text-4xl">
              <a
                ...
                className="text-amber-700 hover:text-amber-800 transition-colors duration-200 outline-none focus:scale-110 hover:scale-110 active:scale-105 cursor-pointer"
